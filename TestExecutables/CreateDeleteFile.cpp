// ファイル:CreateDeleteFile_test.txtをCurrent Directryに作成し，削除するプログラム

#include <Windows.h>

int main(void){

    LPCSTR create_file_name = "./TestExecutables/CreateDeleteFile_test.txt";
    ...
    res = DeleteFile((LPCTSTR)create_file_name);
