// ファイル:CreateDeleteFileA_test.txtをCurrent Directryに作成し，削除するプログラム

#include <Windows.h>

int main(void){

    LPCSTR create_file_name = "./TestExecutables/CreateDeleteFileA_test.txt";
    ...
    res = DeleteFileA(create_file_name);
